...
from functions import get_brand_contents_from_query
...
def generate_response(query: str):
    docs = get_brand_contents_from_query(query)
    content ='\n'.join(docs)
...
st.title("POC 브랜드 정보 조회 모듈 (라운드랩, 가히, 아비브, 아누아, 닥터지)")
...
# 사용자 입력
prompt = st.chat_input("브랜드에 대해 궁금한 점을 입력하세요")
